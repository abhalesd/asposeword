...
namespace DocsExamples.Mail_Merge_and_Reporting
{
    internal class WorkingWithXmlData : DocsExamplesBase
    {
        ...
        public void TestMailMerge()
        {
            ...
            DataSet hausgeldDs = new DataSet();
            hausgeldDs.ReadXml(MyDir + "Mail merge data - test.xml");

            Document doc = new Document(MyDir + "Mail merge destinations - Hausgeldabrechnung.docx");
            doc.MailMerge.Execute(hausgeldDs.Tables["NV"]);

            doc.Save(ArtifactsDir + "Hausgelabrechnung.XmlMailMerge.docx");
            //ExEnd:XmlMailMerge
        }

        [Test]
        public void HausgeldAbrechnungMailMerge()
        {
            //ExStart:XmlMailMerge
            DataSet hausgeldDs = new DataSet();
            hausgeldDs.ReadXml(MyDir + "Mail merge data - hausgeld_full.xml");
        ...
        [Test]
        public void HausgeldAbrechnungMustacheSyntaxUsingDataSet()
        {
            ...
            doc.Save(ArtifactsDir + "Hausgelabrechnung.MustacheSyntaxUsingDataSet.docx");
        ...
        [Test]
        public void MustacheSyntaxUsingDataSetHLRE()
        {
            //ExStart:MailMergeUsingMustacheSyntax
            DataSet ds = new DataSet();
            ds.ReadXml(MyDir + "Mail merge data - Orders.xml");

            Document doc = new Document(MyDir + "Mail merge destinations - VendorTest.docx");

            doc.MailMerge.UseNonMergeFields = true;

            doc.MailMerge.ExecuteWithRegions(ds);

            doc.Save(ArtifactsDir + "WorkingWithXmlData.MustacheSyntaxUsingDataSetHLRE.docx");
            //ExEnd:MailMergeUsingMustacheSyntax
        }
